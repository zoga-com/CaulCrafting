...
public class CraftArray implements ConfigurationSerializable{
	...
	public ArrayList<ItemStack> getResultItems() {
		return new ArrayList<ItemStack>(result.keySet());
	}
	...
	public boolean isEmpty() {
		return this.getCraft().isEmpty() || this.isRedstonepower() || this.getResult().isEmpty() || this.getCmds().isEmpty();
	}
	...
	public Map<String, Object> serialize() {
		...
		ArrayList<ItemStack> seresult = new ArrayList<ItemStack>(ofresult.keySet());
        map.put("result.items", seresult);
		ArrayList<Integer> seresultprobs = new ArrayList<Integer>(ofresult.values());
